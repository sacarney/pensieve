...
function template_main()
{
  ...
  echo '
  <div class="container" id="whos_online">
    <form action="', $scripturl, '?action=who" method="post" id="whoFilter" accept-charset="', $context['character_set'], '">
      ...
      <div class="level">
        ...
        <div class="level-right">
          <span class="mr-2">', $txt['who_show1'], '</span>
          <div class="select">
      ...
      echo '
        <table class="table is-striped is-bordered is-narrow is-fullwidth" cellspacing="0">
          <thead>
            <tr class="catbg">
              <th scope="col" class="lefttext first_th"><a href="', $scripturl, '?action=who;start=', $context['start'], ';show=', $context['show_by'], ';sort=user', $context['sort_direction'] != 'down' && $context['sort_by'] == 'user' ? '' : ';asc', '" rel="nofollow">', $txt['who_user'], ' ', $context['sort_by'] == 'user' ? '<img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>
              <th scope="col" class="lefttext"><a href="', $scripturl, '?action=who;start=', $context['start'], ';show=', $context['show_by'], ';sort=time', $context['sort_direction'] == 'down' && $context['sort_by'] == 'time' ? ';asc' : '', '" rel="nofollow">', $txt['who_time'], ' ', $context['sort_by'] == 'time' ? '<img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>
              <th scope="col" class="lefttext last_th">', $txt['who_action'], '</th>
            </tr>
          </thead>
          <tbody>';
