  ...
  if ($context['show_coppa'])
    echo '
      <div class="field">
        ...
        <p class="control">
          <input type="submit" name="accept_agreement_coppa" value="', $context['coppa_agree_below'], '" class="button is-primary" />
        </p>
      </div>
    ';
  else
    echo '
        <input type="submit" name="accept_agreement" value="', $txt['agreement_agree'], '" class="button is-primary" />';
...
function template_registration_form()
{
    ...
    <div class="columns is-centered">
      ...
      <form action="', $scripturl, '?action=register2" method="post" accept-charset="', $context['character_set'], '" name="registration" id="registration" onsubmit="return verifyAgree();">
        ...
        <div class="card register-card">
          ...
          <div class="field">
            <p class="control">
              <label class="checkbox" for="allow_email">
        ...
        {
          echo '
            <p>', $txt['authenticate_label'], '<a href="', $scripturl, '?action=helpadmin;help=register_openid" onclick="return reqWin(this.href);" class="help">(?)</a></p>

            <div class="field">
              <p class="control">
                <label class="radio" for="auth_pass" id="option_auth_pass">
                ...
                <label class="radio" for="auth_openid" id="option_auth_openid">
  ...
  if ($context['visual_verification'])
  {
    ...
    <div class="card register-card">
      <div class="card-header">
        <p class="card-header-title">', $txt['verification'], '</p>
      </div>
      <div class="card-content">
