    ...
    <form action="', $scripturl, '?action=admin;area=managesearch;sa=weights" method="post" accept-charset="', $context['character_set'], '">
      ...
      <div class="field is-horizontal">
        <div class="field-label has-text-left">
          <a id="setting_removeNestedQuotes" href="', $scripturl, '?action=helpadmin;help=search_weight_frequency" onclick="return reqWin(this.href); onclick="return reqWin(this.href);">
            <span class="icon is-small">
              <span class="fa fa-question-circle"></span>
            </span>
          </a>
          <span><label>', $txt['search_weight_frequency'], '</label></span>
        </div>
        <div class="field-body">
          <div class="field">
            <input type="text" name="search_weight_frequency" id="weight1_val" value="', empty($modSettings['search_weight_frequency']) ? '0' : $modSettings['search_weight_frequency'], '" onchange="calculateNewValues()" size="3" class="input is-auto" />
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label has-text-left">
          <a href="', $scripturl, '?action=helpadmin;help=search_weight_age" onclick="return reqWin(this.href);">
            <span class="icon is-small">
              <span class="fa fa-question-circle"></span>
            </span>
          </a>
          <span><label>', $txt['search_weight_age'], '</label></span>
        </div>
        <div class="field-body">
          <div class="field">
            <input type="text" name="search_weight_age" id="weight2_val" value="', empty($modSettings['search_weight_age']) ? '0' : $modSettings['search_weight_age'], '" onchange="calculateNewValues()" size="3" class="input is-auto" />
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label has-text-left">
          <a href="', $scripturl, '?action=helpadmin;help=search_weight_length" onclick="return reqWin(this.href);">
            <span class="icon is-small">
              <span class="fa fa-question-circle"></span>
            </span>
          </a>
          <span><label>', $txt['search_weight_length'], '</label></span>
        </div>
        <div class="field-body">
          <div class="field">
            <input type="text" name="search_weight_length" id="weight3_val" value="', empty($modSettings['search_weight_length']) ? '0' : $modSettings['search_weight_length'], '" onchange="calculateNewValues()" size="3" class="input is-auto" />
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label has-text-left">
          <a href="', $scripturl, '?action=helpadmin;help=search_weight_subject" onclick="return reqWin(this.href);">
            <span class="icon is-small">
              <span class="fa fa-question-circle"></span>
            </span>
          </a>
          <span><label>', $txt['search_weight_subject'], '</label></span>
        </div>
        <div class="field-body">
          <div class="field">
            <input type="text" name="search_weight_subject" id="weight4_val" value="', empty($modSettings['search_weight_subject']) ? '0' : $modSettings['search_weight_subject'], '" onchange="calculateNewValues()" size="3" class="input is-auto" />
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label has-text-left">
          <a href="', $scripturl, '?action=helpadmin;help=search_weight_first_message" onclick="return reqWin(this.href);">
            <span class="icon is-small">
              <span class="fa fa-question-circle"></span>
            </span>
          </a>
          <span><label>', $txt['search_weight_first_message'], '</label></span>
        </div>
        <div class="field-body">
          <div class="field">
            <input type="text" name="search_weight_first_message" id="weight5_val" value="', empty($modSettings['search_weight_first_message']) ? '0' : $modSettings['search_weight_first_message'], '" onchange="calculateNewValues()" size="3" class="input is-auto" />
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label has-text-left">
          <a href="', $scripturl, '?action=helpadmin;help=search_weight_frequency" onclick="return reqWin(this.href);">
            <span class="icon is-small">
              <span class="fa fa-question-circle"></span>
            </span>
          </a>
          <span><label>', $txt['search_weight_sticky'], '</label></span>
        </div>
        <div class="field-body">
          <div class="field">
            <input type="text" name="search_weight_sticky" id="weight6_val" value="', empty($modSettings['search_weight_sticky']) ? '0' : $modSettings['search_weight_sticky'], '" onchange="calculateNewValues()" size="3" class="input is-auto" />
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label has-text-left">
          <span><label>', $txt['search_weights_total'], '</label></span>
        </div>
        <div class="field-body">
          <div class="field">
      ...
      <input type="submit" name="save" value="', $txt['search_weights_save'], '" class="button is-primary" />
...
function template_select_search_method()
{
  ...
  echo '
          ...
          <div class="clear">
            <input type="submit" name="save" value="', $txt['search_method_save'], '" class="button is-primary mt-3" />
            <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
          </div>
        </div>
