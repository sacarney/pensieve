...
function template_new_group()
{
  ...
  <div id="admincenter">
    <form action="', $scripturl, '?action=admin;area=membergroups;sa=add" method="post" accept-charset="', $context['character_set'], '">
      <div class="cat_bar">
        <h3 class="title is-5 mb-4">', $txt['membergroups_new_group'], '</h3>
      </div>
      <div class="windowbg">
        <div class="content">
          ...
          <div class="field is-horizontal">
            <div class="field-label has-text-left is-narrow">
              <label class="label" for="group_name_input">', $txt['membergroups_group_name'], '</label>
            </div>
            <div class="field-body">
              <div class="field is-narrow">
                <input type="text" name="group_name" id="group_name_input" size="30" class="input" />
              </div>
            </div>
          </div>
          ';
          ...
          <div class="field is-horizontal">
            <div class="field-label has-text-left is-narrow">
              <label class="label" for="group_name_input">', $txt['membergroups_edit_group_type'], '</label>
            </div>
            <div class="field-body">
              <div class="field">
                <fieldset id="group_type">
                  <legend>', $txt['membergroups_edit_select_group_type'], '</legend>
                  <label class="radio" for="group_type_private"><input type="radio" name="group_type" id="group_type_private" value="0" checked="checked" class="input_radio" onclick="swapPostGroup(0);" />  ', $txt['membergroups_group_type_private'], '</label><br />';
                  if ($context['allow_protected'])
                  echo'
                  <label class="radio" for="group_type_protected"><input type="radio" name="group_type" id="group_type_protected" value="1" class="input_radio" onclick="swapPostGroup(0);" />  ', $txt['membergroups_group_type_protected'], '</label><br />';
                  echo'
                  <label class="radio" for="group_type_request"><input type="radio" name="group_type" id="group_type_request" value="2" class="input_radio" onclick="swapPostGroup(0);" />  ', $txt['membergroups_group_type_request'], '</label><br />
                  <label class="radio" for="group_type_free"><input type="radio" name="group_type" id="group_type_free" value="3" class="input_radio" onclick="swapPostGroup(0);" />  ', $txt['membergroups_group_type_free'], '</label><br />
                  <label class="radio" for="group_type_post"><input type="radio" name="group_type" id="group_type_post" value="-1" class="input_radio" onclick="swapPostGroup(1);" />  ', $txt['membergroups_group_type_post'], '</label><br />
                </fieldset>';
          ...
          <div class="field is-horizontal">
            <div class="field-label has-text-left is-narrow">
              <label class="label" for="group_name_input">', $txt['membergroups_min_posts'], '</label>
            </div>
            <div class="field-body">
              <div class="field is-narrow">
                <input type="text" name="min_posts" id="min_posts_input" size="5" class="input" />
              </div>
            </div>
          </div>';
          ...
          <div class="field is-horizontal">
            <div class="field-label has-text-left is-narrow">
              <label class="label" for="group_name_input">', $txt['membergroups_permissions'], '</label>
              <div class="is-muted">', $txt['membergroups_can_edit_later'], '</div>
            </div>
            <div class="field-body">
              <div class="field">
                <fieldset id="permission_base">
                  ...
                  <div class="field is-grouped mb-2">
                    <div class="control">
                      <label for="perm_type_inherit"><input type="radio" name="perm_type" id="perm_type_inherit" value="inherit" checked="checked" class="input_radio" />  ', $txt['membergroups_new_as_inherit'], ':</label>
                    </div>
                    <div class="control">
                      <div class="select">
                  ...
                  <div class="field is-grouped mb-2">
                    <div class="control">
                      <label for="perm_type_copy"><input type="radio" name="perm_type" id="perm_type_copy" value="copy" class="input_radio" />  ', $txt['membergroups_new_as_copy'], ':</label>
                    </div>
                    <div class="control">
                      <div class="select">
                  ...
                  <div class="field is-grouped mb-2">
                    <div class="control">
                      <label for="perm_type_copy"><input type="radio" name="perm_type" id="perm_type_predefined" value="predefined" class="input_radio" />  ', $txt['membergroups_new_as_type'], ':</label>
                    </div>
                    <div class="control">
                      <div class="select">
          ...
          <div class="field is-horizontal">
            <div class="field-label has-text-left is-narrow">
              <label class="label">', $txt['membergroups_new_board'], ': ', $context['post_group'] ? '<br />
                <span class="is-muted" style="font-weight: normal">' . $txt['membergroups_new_board_post_groups'] . '</span>' : '', '
              </label>
            </div>
            <div class="field-body">
              <div class="field">
          ...
          <input type="submit" value="', $txt['membergroups_add_group'], '" class="button is-primary" />
...
function template_group_members()
{
  ...
  if (!empty($context['group']['assignable']))
    echo '
        <div class="floatright"><input type="submit" name="remove" value="', $txt['membergroups_members_remove'], '" class="button is-primary" /></div>';
  echo '
      </div>
      <br />';
    ...
    echo '
      ...
      <div class="windowbg">
        ...
        <div class="content">
          ...
          <input type="text" name="toAdd" id="toAdd" value="" class="input" />
          <div id="toAddItemContainer"></div>
          <input type="submit" name="add" value="', $txt['membergroups_members_add'], '" class="button is-primary" />
        </div>
        <span class="botslice"><span></span></span>
      </div>';
  }
...
function template_group_request_reason()
{
  ...
  echo '
          ...
          <input type="submit" name="go" value="', $txt['mc_groupr_submit'], '" class="button is-primary" />
