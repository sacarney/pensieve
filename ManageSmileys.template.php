...
function template_modifyset()
{
  ...
  <div id="admincenter">
    ...
    echo '
          ...
          <input type="submit" value="', $txt['smiley_sets_save'], '" class="button is-primary" />
        </div>
        <span class="botslice"><span></span></span>
      </div>
  ...
  <div id="admincenter">
    ...
    echo '
      ...
      echo '
          ...
          <input type="submit" value="', $txt['smileys_save'], '" class="button is-primary" />
          <input type="submit" name="deletesmiley" value="', $txt['smileys_delete'], '" onclick="return confirm(\'', $txt['smileys_delete_confirm'], '\');" class="button is-primary" />
        </div>
        <span class="botslice"><span></span></span>
      </div>
      <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
