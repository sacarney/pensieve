...
function template_main()
{
  ...
  echo '
    <div class="cat_bar">
      <h2 class="title is-5 mb-3">', $context['page_title'], '</h2>
    </div>
  ...
  // @TODO Are you posting a calendar event?
  if ($context['make_event'])
  {
    echo '
          <div id="post_event">
  ...
  // @TODO If this is a poll then display all the poll options!
  if ($context['make_poll'])
  {
    echo '
          <div id="edit_poll">
  ...
  echo '
          <p class="is-muted mt-2 mb-2" id="shortcuts">
  ...
  // @TODO The functions used to preview a posts without loading a new page.
  echo '
  ...
  if (isset($context['previous_posts']) && count($context['previous_posts']) > 0)
  {
    ...
    foreach ($context['previous_posts'] as $post)
    {
        ...
        <div class="box">
          ...
          <div class="is-flex">
            <div class="flex-grow-1">
              <h3><span class="sr-only">', $txt['posted_by'], ' </span>', $post['poster'], '<br><span class="is-size-7">', $post['time'] ,'</h3>
            </div>';

            if($context['can_quote']) {
              echo '
              <div>
                <a href="#postmodify" onclick="return insertQuoteFast(', $post['id'], ');" class="button is-small">
                  <span class="icon"><span class="fa fa-quote-left"></span></span>
                  <span>',$txt['bbc_quote'],'</span>
                </a>
              </div>
              ';
            }
      ...
      {
        echo '
          <div id="msg_', $post['id'], '_ignored_prompt" class="is-muted is-size-6-5">
            ', $txt['ignoring_user'], '
      ...
      echo '
          <div class="content" id="msg_', $post['id'], '_body">', $post['message'], '</div>
        </div>
      ';
    }
