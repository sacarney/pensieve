...
function template_maintain_database()
{
  ...
  if (!empty($context['maintenance_finished']))
    echo '
      <div class="message is-success">
        <div class="message-body">', sprintf($txt['maintain_done'], $context['maintenance_finished']), '</div>
      </div>';
  ...
  <div id="manage_maintenance">
    ...
    <form action="', $scripturl, '?action=admin;area=maintain;sa=database;activity=optimize" method="post" accept-charset="', $context['character_set'], '">
      ...
      <input type="submit" value="', $txt['maintain_run_now'], '" class="button is-small mt-3 mb-3" />
      <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
    </form>

    <div class="cat_bar">
      <h3 class="catbg">
        <a href="', $scripturl, '?action=helpadmin;help=maintenance_backup" onclick="return reqWin(this.href);" >
          <span class="icon is-small"><span class="fa fa-question-circle"></span></span>
    ...
    <form action="', $scripturl, '?action=admin;area=maintain;sa=database;activity=backup" method="post" accept-charset="', $context['character_set'], '">
      ...
      if ($db_type == 'sqlite')
        echo '
          <input type="submit" value="', $txt['maintain_backup_save'], '" id="submitDump" class="button is-small" />';
      else
        echo '
          <div class="mt-4">
            <label for="struct"><input type="checkbox" name="struct" id="struct" onclick="document.getElementById(\'submitDump\').disabled = !document.getElementById(\'struct\').checked &amp;&amp; !document.getElementById(\'data\').checked;" class="input_check" checked="checked" /> ', $txt['maintain_backup_struct'], '</label>
            <br>
            <label for="data"><input type="checkbox" name="data" id="data" onclick="document.getElementById(\'submitDump\').disabled = !document.getElementById(\'struct\').checked &amp;&amp; !document.getElementById(\'data\').checked;" checked="checked" class="input_check" /> ', $txt['maintain_backup_data'], '</label>
            <br>
          ...
          <div class="mt-4 mb-4">
            <input type="submit" value="', $txt['maintain_backup_save'], '" id="submitDump" onclick="return document.getElementById(\'struct\').checked || document.getElementById(\'data\').checked;" class="button is-small" />
          </div>';
    ...
    if ($context['convert_utf8'])
    {
      ...
      <form action="', $scripturl, '?action=admin;area=maintain;sa=database;activity=convertutf8" method="post" accept-charset="', $context['character_set'], '">
        ...
        <p>', $txt['utf8_introduction'], '</p>
            ', !empty($modSettings['search_index']) && $modSettings['search_index'] == 'fulltext' ? '<p class="text-is-danger">' . $txt['utf8_cannot_convert_fulltext'] . '</p>' : '', '
        <div class="mt-4 mb-4">
          <input type="submit" value="', $txt['maintain_run_now'], '" class="button is-small" ', !empty($modSettings['search_index']) && $modSettings['search_index'] == 'fulltext' ? 'disabled="disabled"' : '', '/>
        </div>
        <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
      </form>';
    }
    ...
    if ($context['convert_entities'])
    {
      ...
      <form action="', $scripturl, '?action=admin;area=maintain;sa=database;activity=convertentities" method="post" accept-charset="', $context['character_set'], '">
        ...
        <div class="mt-4 mb-4">
          <input type="submit" value="', $txt['maintain_run_now'], '" class="button is-small" />
          <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
        </div>
      </form>';
    }
...
function template_maintain_members()
{
  ...
  <div id="manage_maintenance">
    ...
    <form action="', $scripturl, '?action=admin;area=maintain;sa=members;activity=reattribute" method="post" accept-charset="', $context['character_set'], '">
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <label class="label">', $txt['reattribute_guest_posts'], '</label>
        </div>
        <div class="field-body">
          <div class="field">
            <div class="control mb-3">
              <label for="type_email" class="mr-2"><input type="radio" name="type" id="type_email" value="email" checked="checked" class="input_radio" /> ', $txt['reattribute_email'], '</label>
              <input class="input is-auto" type="text" name="from_email" id="from_email" value="" onclick="document.getElementById(\'type_email\').checked = \'checked\'; document.getElementById(\'from_name\').value = \'\';" />
            </div>
            <div class="control">

              <label for="type_name" class="mr-2"><input type="radio" name="type" id="type_name" value="name" class="input_radio" /> ', $txt['reattribute_username'], '</label>
              <input class="input is-auto" type="text" name="from_name" id="from_name" value="" onclick="document.getElementById(\'type_name\').checked = \'checked\'; document.getElementById(\'from_email\').value = \'\';" class="input_text" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <label class="label" for="to">', $txt['reattribute_current_member'], '</label>
        </div>
        <div class="field-body">
          <div class="field">
            <input type="text" name="to" id="to" value="" class="input is-auto" />
          </div>
        </div>
      </div>
      ...
      <div class="mt-4 mb-4 has-text-right">
        <input type="submit" id="do_attribute" value="', $txt['reattribute'], '" onclick="if (!checkAttributeValidity()) return false; return confirm(warningMessage);" class="button is-small" /></span>
        <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
      </div>
    </form>
    ...
    <div class="cat_bar">
      <h3 class="catbg">
        <span class="ie6_header floatleft">
          <a href="', $scripturl, '?action=helpadmin;help=maintenance_members" onclick="return reqWin(this.href);">
            <span class="icon is-small">
              <span class="fa fa-question-circle"></span>
            </span>
          </a> ', $txt['maintain_members'], '
        </span>
      </h3>
    </div>
    ...
    <form action="', $scripturl, '?action=admin;area=maintain;sa=members;activity=purgeinactive" method="post" accept-charset="', $context['character_set'], '" id="membersForm">
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <label class="label"><a id="membersLink"></a>', $txt['maintain_members_since1'], '</label>
        </div>
        <div class="field-body">
          <div class="field">
            <div class="select">
            ...
            </div>', $txt['maintain_members_since2'], ' <input type="text" name="maxdays" value="30" size="3" class="input_text" />', $txt['maintain_members_since3'], '
          </div>
        </div>
      </div>';
      ...
      echo '
        ...
        <div class="mt-4 mb-4 has-text-right">
          <input type="submit" value="', $txt['maintain_old_remove'], '" onclick="return confirm(\'', $txt['maintain_members_confirm'], '\');" class="button is-small" /></span>
          <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
        </div>
    </form>
  </div>
  ...
  <div id="manage_maintenance">
    ...
    <form action="', $scripturl, '?action=admin;area=maintain;sa=topics;activity=pruneold" method="post" accept-charset="', $context['character_set'], '">';
      ...
      echo '
        <div class="field is-horizontal">
          <div class="field-label">
            <label class="label"><a id="rotLink"></a>', $txt['maintain_old_since_days1'], '</label>
          </div>
          <div class="field-body">
            <div class="field">
              <div class="control">
                <input class="input is-auto mr-2" type="text" name="maxdays" value="30" size="3" /> ', $txt['maintain_old_since_days2'], '
              </div>
              <div class="control mt-4">
                ...
                <label for="delete_type_locked"><input type="radio" name="delete_type" id="delete_type_locked" value="locked" class="input_radio" /> ', $txt['maintain_old_are_locked'], '</label>
              </div>
              <div class="control mt-4">';
                if (!empty($modSettings['enableStickyTopics']))
                echo '
                  <label for="delete_old_not_sticky"><input type="checkbox" name="delete_old_not_sticky" id="delete_old_not_sticky" class="input_check" checked="checked" /> ', $txt['maintain_old_are_not_stickied'], '</label>';
        ...
        <div class="mt-3 mb-4 has-text-right">
          <input type="submit" value="', $txt['maintain_old_remove'], '" onclick="return confirm(\'', $txt['maintain_old_confirm'], '\');" class="button is-small" />
          <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
        </div>
    </form>
    ...
    <form action="', $scripturl, '?action=admin;area=maintain;sa=topics;activity=massmove" method="post" accept-charset="', $context['character_set'], '">
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <label class="label" for="id_board_from">', $txt['move_topics_from'], ' </label>
        </div>
        <div class="field-body">
          <div class="field">
            <div class="select">
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <label class="label" for="id_board_to">', $txt['move_topics_to'], '</label>
        </div>
        <div class="field-body">
          <div class="field">
            <div class="select">
  ...
  <div id="manage_maintenance">
    ...
    <div class="content">
      ...
      <form action="', $scripturl, '?action=admin;area=maintain;sa=database;activity=convertentities;start=0;', $context['session_var'], '=', $context['session_id'], '" method="post" accept-charset="', $context['character_set'], '">
        ...
        <div class="mt-4 mb-4 has-text-right">
          <input type="submit" value="', $txt['entity_convert_proceed'], '" class="button is-small" />
        </div>
      </form>
    </div>
  </div>';
