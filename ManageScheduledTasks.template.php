...
function template_view_scheduled_tasks()
{
  ...
  if (!empty($context['tasks_were_run']))
    echo '
  <div id="task_completed" class="message is-success">
    <div class="message-body">', $txt['scheduled_tasks_were_run'], '</div>
  </div>';
    ...
    <form action="', $scripturl, '?action=admin;area=scheduledtasks;sa=taskedit;save;tid=', $context['task']['id'], '" method="post" accept-charset="', $context['character_set'], '">
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <div class="label">', $txt['scheduled_tasks_name'], '</div>
        </div>
        <div class="field-body">
          <div class="field">
            ', $context['task']['name'], '<br />
              <span class="help">', $context['task']['desc'], '</span>
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <label class="label">', $txt['scheduled_task_edit_interval'], '</label>
        </div>
        <div class="field-body">
          <div class="field">
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <label class="label">', $txt['scheduled_task_edit_start_time'], '</label>
        </div>
        <div class="field-body">
          <div class="field">
            <input type="text" name="offset" value="', $context['task']['offset_formatted'], '" size="6" maxlength="5" class="input is-auto" />
            <span class="help">', $txt['scheduled_task_edit_start_time_desc'], '</span>
          </div>
        </div>
      </div>
      ...
      <div class="field is-horizontal">
        <div class="field-label">
          <label class="label">', $txt['scheduled_tasks_enabled'], '</label>
        </div>
        <div class="field-body">
          <div class="field">
      ...
      <div class="mt-3 mb-3 has-text-right">
        ...
        <input type="submit" name="save" value="', $txt['scheduled_tasks_save_changes'], '" class="button is-small" />
      </div>
