...
function template_main()
{
  ...
  <div id="statistics" class="container">
    <div class="cat_bar">
      <h2 class="title is-5 mb-4">', $context['page_title'], '</h2>
    </div>

    <div class="card">
      <div class="card-header">
        <h3 class="card-header-title title is-5 mb-0">
          <span class="icon mr-2"><span class="fa fa-pie-chart"></span></span>
          <span>', $txt['general_stats'], '</span>
        </h3>
      </div>
      <div class="card-content">
        <div class="columns">
          <div class="column">
            <dl class="pensieve-stat-list is-size-6-5">
    ...
    <div class="columns">
      <div class="column">
        <div class="card">
          <div class="card-header">
            <h3 class="card-header-title title is-5 mb-0">
            <span class="icon mr-2"><span class="fa fa-trophy"></span></span>
            <span>', $txt['top_posters'], '</span>
          </h3>
          </div>
          <div class="card-content">
            <dl class="pensieve-stat-list is-size-6-5">';
      ...
      <div class="column">
        <div class="card">
          <div class="card-header">
            <h3 class="card-header-title title is-5 mb-0">
            <span class="icon mr-2"><span class="fa fa-list-ul"></span></span>
            <span>', $txt['top_boards'], '</span>
          </h3>
          </div>
          <div class="card-content">
            <dl class="pensieve-stat-list is-size-6-5">';
    ...
    <div class="columns">
      <div class="column">
        <div class="card">
          <div class="card-header">
            <h3 class="card-header-title title is-5 mb-0">
            <span class="icon mr-2"><span class="fa fa-file-text-o"></span></span>
            <span>', $txt['top_topics_replies'], '</span>
          </h3>
          </div>
          <div class="card-content">
            <dl class="pensieve-stat-list is-size-6-5">';
      ...
      <div class="column">
        <div class="card">
          <div class="card-header">
            <h3 class="card-header-title title is-5 mb-0">
            <span class="icon mr-2"><span class="fa fa-file-text-o"></span></span>
            <span>', $txt['top_topics_views'], '</span>
          </h3>
          </div>
          <div class="card-content">
            <dl class="pensieve-stat-list is-size-6-5">';
    ...
    <div class="columns">
      <div class="column">
        <div class="card">
          <div class="card-header">
            <h3 class="card-header-title title is-5 mb-0">
            <span class="icon mr-2"><span class="fa fa-star-o"></span></span>
            <span>', $txt['top_starters'], '</span>
          </h3>
          </div>
          <div class="card-content">
            <dl class="pensieve-stat-list is-size-6-5">';
      ...
      <div class="column">
        <div class="card">
          <div class="card-header">
            <h3 class="card-header-title title is-5 mb-0">
            <span class="icon mr-2"><span class="fa fa-clock-o"></span></span>
            <span>', $txt['most_time_online'], '</span>
          </h3>
          </div>
          <div class="card-content">
            <dl class="pensieve-stat-list is-size-6-5">';
    ...
    <div class="card">
      ...
      <div class="card-content">';
        ...
        {
          echo '
          <table border="0" width="100%" cellspacing="1" cellpadding="4" class="table is-narrow" id="stats">
            <thead>
